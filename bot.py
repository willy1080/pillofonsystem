...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        if username not in config.PV_USERS:
            bot.sendMessage(update.message.chat.id,'🚫Pídele acceso🛇 a mi desarrollador: @pillofone')
            return
        ...
        if '/start' in msgText:
            ...
            start_msg+= 'Devela  : @pillofone ⭐Desarrollador⭐\n'
            start_msg+= 'Api     : Telegram.org\n'
            start_msg+= 'Soy el bot de uso personal de @pillofone Usuarios Permitidos=@Mykel13X\n'
